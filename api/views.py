...
from .tasks import send_prescription_reminder_sms
...
# =================================================================================
# --- CONSULTATION VIEW WITH AUTOMATED REMINDER SCHEDULING ENGINE ---
# =================================================================================
class ConsultationCreateView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
                    ...
                    for item in new_prescription_items:
                        ...
                        for day in range(1, int(item.duration_days) + 1):
                            ...
                            if item.timing_morning:
                                ...
                                send_prescription_reminder_sms.apply_async(args=[patient.phone_number, message], eta=schedule_datetime)
            ...
            # Restored the original, clean error handling
